...
Sign_In_btn.onclick = function() { signInModal.style.display = "block"; }


SignInSpan.onclick = function() { signInModal.style.display = "none"; }
...
hyper.onclick = function() { signInModal.style.display = "none";
